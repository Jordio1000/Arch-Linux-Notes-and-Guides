...
4. Make sure `/etc/fstab` is modified to include `/swap/swapfile none swap defaults 0 0` after the fstab has been generated. If you created your swapfile before generating fstab, it should be added automatically at generation.
...
4. Install GRUB with `grub-install --target=x86_64-efi --efi-directory=/efi --bootloader-id=*GRUB* --recheck`.
	- Your `boodloader-id` is just an identifying name for your bootloader. It can be changed to whatever you want it to be.
...
## Reference Guides
These are the main guides I used while installing Arch. You will probably notice some places where this guide is the same as theirs. I just wanted to make sure to credit their work as well as they helped me immensely in this project.
- [Arch Wiki Installation Guide](https://wiki.archlinux.org/title/Installation_guide#)
- [Uses btrfs and encryption, but it uses /boot as its boot partition instead of /efi. Still very good for most of the setup. Credit: Radley Lewis on Github](https://github.com/radleylewis/arch_installation_guide)
- [Uses btrfs but no encryption. Has a lot of extra info for KDE, gaming, and GPU drivers. Credit: mjkstra on Github](https://gist.github.com/mjkstra/96ce7a5689d753e7a6bdd92cdc169bae)
